...
extern struct fieldInstances {
    ...
    *fieldInstances_floats_ptr, *fieldInstances_ints_ptr, *fieldInstances_strings_ptr;
//----------------------------------------------------------------
...
} layerInstances, *layerInstances_details_ptr, *autoTiles_data_ptr, *gridTiles_data_ptr,
    *entityInstances_data_ptr, *integerGrid_data_ptr;
//----------------------------------------------------------------
